  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-4xl bg-white border border-[#E6D5C3] rounded-3xl shadow-2xl overflow-hidden max-h-[92vh] flex flex-col animate-in fade-in zoom-in-95 duration-200"
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 bg-[#F5F1EE] border-b border-[#E6D5C3] shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handleShare}
              className="p-1.5 text-[#8C7355] hover:text-[#8B5E34] hover:bg-black/5 rounded-lg text-xs flex items-center gap-1 cursor-pointer"
            ...
            <button
              ...
              className="text-[#8C7355] hover:text-[#3E2723] p-1.5 rounded-lg hover:bg-black/5 cursor-pointer font-bold"
            >
              ✕
            </button>
          </div>
