  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-md overflow-hidden bg-white border border-[#E6D5C3] rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[92vh]"
      >
