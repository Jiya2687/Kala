...
export const DeliveryTracking: React.FC<DeliveryTrackingProps> = ({
  ...
  const handleCopyTracking = () => {
    if (order?.trackingId && typeof navigator !== 'undefined' && navigator.clipboard?.writeText) {
          ...
          <div className="space-y-2.5 text-xs text-[#3E2723]">
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                <strong className="text-sm">{order.shippingDetails?.fullName || 'Valued Customer'}</strong>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>
                ...
                <strong>{order.shippingDetails?.phone || 'N/A'}</strong>
              </span>
            </div>
